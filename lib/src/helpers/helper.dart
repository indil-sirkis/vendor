...
//        },
  ...
  String trans(String text,String type) {
    switch (text) {
      case "App\\Notifications\\MarketRequestApprove":
        return S.of(context).market_request_approved;
      case "App\\Notifications\\MarketRequest":
        return S.of(context).market_request;
