...
class S {
  ...
  /// `Order status changed`
  String get market_request_approved {
    return Intl.message(
      'Market Request Approved',
      name: 'market_request_approved',
      desc: '',
      args: [],
    );
  }
  /// `Order status changed`
  String get market_request {
    return Intl.message(
      'Market Request',
      name: 'market_request',
      desc: '',
  ...
  String get youDontHaveMarketsPleaseSigninUsingAdminPanelAnd {
    return Intl.message(
      'You don\'t have stores, please sign-in using admin panel and open new store',
      name: 'youDon\'tHavestoresPleaseSigninUsingAdminPanelAndopen new store',
      desc: '',
      args: [],
    );
  }
